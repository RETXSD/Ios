...
- `references/healthkit.md` - HealthKit permission, reading active energy, saving workouts.
- `references/coreml-vision.md` - Camera setup, body pose detection, Core ML inference.
- `references/qa-appstore.md` - Testing, privacy checklist, App Store submission.
